...
This combines the immersion of real-world objects with the convenience of a mobile app.
  ...
  },
  {
    ...
    shortDescription:
      "Generate a professional portfolio site from your GitHub profile.",
    fullDescription: `
...
This would help users save money while reducing their environmental impact.
  ...
  },
  {
    ...
    shortDescription:
      "A dashboard to track expenses, investments, and financial goals.",
    fullDescription: `
...
This would reduce food waste and make meal planning easier.
  ...
  },
  {
    ...
    shortDescription:
      "Platform for students to form study groups and collaborate remotely.",
    fullDescription: `
...
This would make remote learning more effective and social.
  ...
  },
  {
    ...
    shortDescription:
      "Smart system to monitor and automate plant care at home.",
    fullDescription: `
...
Perfect for plant enthusiasts and those who travel frequently.
  ...
  },
  {
    ...
    shortDescription:
      "App to discover and support small local businesses in your area.",
    fullDescription: `
...
This would help strengthen local economies and build community connections.
  ...
  },
  {
    ...
    shortDescription:
      "AR app to visualize furniture and decor in your space before buying.",
    fullDescription: `
...
This would make home decorating more accessible and reduce purchase regrets.
  ...
  },
  {
    ...
    shortDescription:
      "Platform for people to teach and learn skills from each other.",
    fullDescription: `
...
This would democratize education and build community connections.
  ...
  },
  {
    ...
    shortDescription:
      "App to track mood patterns and practice mindfulness techniques.",
    fullDescription: `
...
This would help users understand their mental health patterns and develop healthy coping strategies.
  ...
  },
  {
    ...
    shortDescription:
      "Platform for musicians to collaborate on tracks remotely.",
    fullDescription: `
